...
local hl = {
  ...
  Cursor = { fg = c.bg, bg = "#FFFFFF", bold = true },
  lCursor = { fg = c.bg, bg = "#FFFFFF", bold = true },
  CursorIM = { fg = c.bg, bg = "#FFFFFF", bold = true },
  TermCursor = { fg = c.bg, bg = "#FFFFFF", bold = true },
  TermCursorNC = { fg = "#828C9E", bg = "#353A45", bold = true },
